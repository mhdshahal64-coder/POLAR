...
function LoginView({ onLogin, themeMode, onToggleTheme }){
  ...
  return (
    <div className="polar-root" style={{ minHeight:"100vh", display:"flex", alignItems:"center", justifyContent:"center", position:"relative", padding:16 }}>
      ...
      <div className="polar-login-grid" style={{ position:"relative", zIndex:1, width:"100%", maxWidth:920, display:"grid", gridTemplateColumns:"1.1fr 0.9fr", gap:0, border:`1px solid ${T.border}`, borderRadius:12, overflow:"hidden", boxShadow:"0 12px 32px rgba(16,24,40,0.08)" }}>
